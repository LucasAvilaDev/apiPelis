        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idcategoria = table.Column<int>(name: "id_categoria", type: "int", nullable: false),
                    Categoriaidcategoria = table.Column<int>(name: "Categoriaid_categoria", type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@gmail.com", "string", "admin", "admin", "admin" },
                    { 2, "maria@example.com", "string", "María", "1234", "cliente" }
                });
